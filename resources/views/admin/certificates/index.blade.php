...
الشهادات
@endsection
@section('page_name')  الشهادات @endsection
@section('content')
    <div class="row">
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">قائمة الشهادات</h3>
                    <div class="">
        ...
        <div class="modal fade bd-example-modal-lg" id="editOrCreate" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="example-Modal3">الشهادات</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
...
@section('ajaxCalls')
    <script>
        ...
        deleteAny('{{route('certificates.destroy', ':id')}}');

        // Add Using Ajax
        showAddModal('{{route('certificates.create')}}');
        addScript();



        // Edit Using Ajax
        showEditModal('{{route('certificates.edit',':id')}}');
        editScript();
    </script>
@endsection
