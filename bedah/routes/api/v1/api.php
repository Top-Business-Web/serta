...
Route::group(['namespace' => 'api\v1', 'prefix' => 'v1', 'middleware' => ['api_lang']], function () {
    ...
    Route::group(['prefix' => 'products'], function () {
        Route::get('latest', 'ProductController@get_latest_products')->middleware('auth:api');
        Route::get('featured', 'ProductController@get_featured_products');
        Route::get('top-rated', 'ProductController@get_top_rated_products')->middleware('auth:api');
    ...
    Route::group(['prefix' => 'cities'], function () {
        Route::get('/', 'CityController@get_cities');
    });
    ...
    Route::group(['prefix' => 'customer', 'middleware' => 'auth:api'], function () {
        ...
        Route::group(['prefix' => 'order'], function () {
            ...
            Route::post('order-reason-user', 'OrderController@order_reason_user');
        });
        // Chatting
    ...
    Route::group(['prefix' => 'seller'], function () {
        ...
        Route::get('{seller_id}/products', 'SellerController@get_seller_products')->middleware('auth:api');
